...
if (isset($_POST['redacted'])){
      ...
      if ($_POST['redacted'] == 'save') {
            ...
            elseif (strlen($new_name) > 50) $error = 'ФИО студента не должно превышать 50 символов ('.strlen($new_name).')';
            if ($error == ''){
                  mysqli_query($connect, "INSERT INTO `students` (`stud_id`, `fio`, `gp`) VALUES (NULL, '$new_name', '".$_SESSION['gp']."')");
                  header("Location: view.php");
                  exit;
            };
      };
...
<div style="margin-left:20%; margin-right:20%; width:60%;">
      ...
      echo "<h1>Добавление студентов в группу ".$row_group['group_name']."</h1>";
      mysqli_free_result($group_query);
      ?>

      <form method = 'post'>
      <label for="new_name">ФИО нового студента</label>
      <input type='text' name='new_name'>
      <?php
      echo "<font color='red'><b>".$error."<b></font><br>";
      ?>
      <br>
      <button type = 'submit' name='redacted' value='save'>Добавить</button>
      <br>
      <br>
